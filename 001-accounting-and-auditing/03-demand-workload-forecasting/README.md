# Accounting & Auditing — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **demand and workload forecasting** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
