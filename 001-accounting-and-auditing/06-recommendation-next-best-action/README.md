# Accounting & Auditing — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **recommendation and next best action** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
