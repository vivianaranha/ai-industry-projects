# Accounting & Auditing — Operational Optimization

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **operational optimization** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
