# Accounting & Auditing — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **lead and opportunity scoring** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
