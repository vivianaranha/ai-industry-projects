# Accounting & Auditing — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **process bottleneck detection** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
