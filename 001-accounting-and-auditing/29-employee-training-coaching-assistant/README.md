# Accounting & Auditing — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **finance operations** by applying **employee training and coaching assistant** to a realistic financial record. The user persona is typically a **client** or an employee supporting that workflow.
...
- Business outcome specific to Accounting & Auditing
...
- Replace CSV sample data with approved Accounting & Auditing data sources.
