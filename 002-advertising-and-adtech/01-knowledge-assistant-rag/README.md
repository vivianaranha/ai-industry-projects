# Advertising & AdTech — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **knowledge assistant with rag** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
