# Advertising & AdTech — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **predictive maintenance and asset health** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
