# Advertising & AdTech — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **fraud abuse and misuse monitoring** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
