# Advertising & AdTech — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **email form and intake automation** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
