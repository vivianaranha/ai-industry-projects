# Advertising & AdTech — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **employee training and coaching assistant** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
...
- Business outcome specific to Advertising & AdTech
...
- Replace CSV sample data with approved Advertising & AdTech data sources.
