# Advertising & AdTech — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **advertising operations** by applying **audit and control testing assistant** to a realistic campaign. The user persona is typically a **advertiser** or an employee supporting that workflow.
