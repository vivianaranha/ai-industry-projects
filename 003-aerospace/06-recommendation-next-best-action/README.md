# Aerospace — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **aerospace operations** by applying **recommendation and next best action** to a realistic asset event. The user persona is typically a **engineer** or an employee supporting that workflow.
