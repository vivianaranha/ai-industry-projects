# Aerospace — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **aerospace operations** by applying **agentic workflow automation** to a realistic asset event. The user persona is typically a **engineer** or an employee supporting that workflow.
