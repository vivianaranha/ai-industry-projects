# Aerospace — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **aerospace operations** by applying **data quality and entity anomaly detection** to a realistic asset event. The user persona is typically a **engineer** or an employee supporting that workflow.
