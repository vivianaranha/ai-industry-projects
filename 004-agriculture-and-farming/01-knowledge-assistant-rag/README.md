# Agriculture & Farming — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **knowledge assistant with rag** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
