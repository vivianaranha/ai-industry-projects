# Agriculture & Farming — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **intelligent classification and triage** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
