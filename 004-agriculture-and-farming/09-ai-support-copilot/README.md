# Agriculture & Farming — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **ai support copilot** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
