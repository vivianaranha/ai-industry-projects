# Agriculture & Farming — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **lead and opportunity scoring** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
