# Agriculture & Farming — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **sla breach and delay prediction** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
