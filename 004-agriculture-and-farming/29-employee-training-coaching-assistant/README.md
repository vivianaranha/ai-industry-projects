# Agriculture & Farming — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **farm operations** by applying **employee training and coaching assistant** to a realistic field record. The user persona is typically a **farmer** or an employee supporting that workflow.
...
- Business outcome specific to Agriculture & Farming
...
- Replace CSV sample data with approved Agriculture & Farming data sources.
