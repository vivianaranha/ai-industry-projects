# Airlines — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **recommendation and next best action** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
