# Airlines — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **retention and churn prediction** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
