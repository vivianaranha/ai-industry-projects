# Airlines — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **workforce planning and scheduling** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
