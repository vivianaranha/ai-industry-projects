# Airlines — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **lead and opportunity scoring** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
