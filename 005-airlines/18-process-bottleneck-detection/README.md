# Airlines — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **process bottleneck detection** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
