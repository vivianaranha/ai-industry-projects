# Airlines — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **incident response copilot** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
