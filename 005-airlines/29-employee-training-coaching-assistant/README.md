# Airlines — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **airline operations** by applying **employee training and coaching assistant** to a realistic itinerary. The user persona is typically a **passenger** or an employee supporting that workflow.
...
- Business outcome specific to Airlines
...
- Replace CSV sample data with approved Airlines data sources.
