# Airports & Aviation Services — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **airport operations** by applying **risk scoring and prioritization** to a realistic airport event. The user persona is typically a **passenger** or an employee supporting that workflow.
