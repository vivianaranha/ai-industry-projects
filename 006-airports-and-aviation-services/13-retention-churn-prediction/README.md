# Airports & Aviation Services — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **airport operations** by applying **retention and churn prediction** to a realistic airport event. The user persona is typically a **passenger** or an employee supporting that workflow.
