# Airports & Aviation Services — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **airport operations** by applying **data quality and entity anomaly detection** to a realistic airport event. The user persona is typically a **passenger** or an employee supporting that workflow.
