# Airports & Aviation Services — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **airport operations** by applying **employee training and coaching assistant** to a realistic airport event. The user persona is typically a **passenger** or an employee supporting that workflow.
...
- Business outcome specific to Airports & Aviation Services
...
- Replace CSV sample data with approved Airports & Aviation Services data sources.
