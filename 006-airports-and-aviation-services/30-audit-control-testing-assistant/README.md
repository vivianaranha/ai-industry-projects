# Airports & Aviation Services — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **airport operations** by applying **audit and control testing assistant** to a realistic airport event. The user persona is typically a **passenger** or an employee supporting that workflow.
