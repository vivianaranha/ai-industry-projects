# Animal Health & Veterinary Services — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **animal health & veterinary services operations** by applying **workforce planning and scheduling** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
