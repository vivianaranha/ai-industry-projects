# Animal Health & Veterinary Services — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **animal health & veterinary services operations** by applying **employee training and coaching assistant** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
...
- Business outcome specific to Animal Health & Veterinary Services
...
- Replace CSV sample data with approved Animal Health & Veterinary Services data sources.
