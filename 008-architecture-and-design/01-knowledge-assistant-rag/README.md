# Architecture & Design — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **design operations** by applying **knowledge assistant with rag** to a realistic project record. The user persona is typically a **designer** or an employee supporting that workflow.
