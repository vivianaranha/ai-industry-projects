# Architecture & Design — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **design operations** by applying **voice of customer and sentiment intelligence** to a realistic project record. The user persona is typically a **designer** or an employee supporting that workflow.
