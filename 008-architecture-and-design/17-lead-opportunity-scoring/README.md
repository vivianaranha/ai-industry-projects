# Architecture & Design — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **design operations** by applying **lead and opportunity scoring** to a realistic project record. The user persona is typically a **designer** or an employee supporting that workflow.
