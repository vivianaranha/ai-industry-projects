# Architecture & Design — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **design operations** by applying **process bottleneck detection** to a realistic project record. The user persona is typically a **designer** or an employee supporting that workflow.
