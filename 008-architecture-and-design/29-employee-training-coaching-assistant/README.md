# Architecture & Design — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **design operations** by applying **employee training and coaching assistant** to a realistic project record. The user persona is typically a **designer** or an employee supporting that workflow.
...
- Business outcome specific to Architecture & Design
...
- Replace CSV sample data with approved Architecture & Design data sources.
