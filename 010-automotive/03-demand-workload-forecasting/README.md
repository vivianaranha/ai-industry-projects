# Automotive — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **automotive operations** by applying **demand and workload forecasting** to a realistic vehicle event. The user persona is typically a **customer** or an employee supporting that workflow.
