# Automotive — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **automotive operations** by applying **capacity planning forecast** to a realistic vehicle event. The user persona is typically a **customer** or an employee supporting that workflow.
