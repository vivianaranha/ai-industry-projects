# Automotive — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **automotive operations** by applying **employee training and coaching assistant** to a realistic vehicle event. The user persona is typically a **customer** or an employee supporting that workflow.
...
- Business outcome specific to Automotive
...
- Replace CSV sample data with approved Automotive data sources.
