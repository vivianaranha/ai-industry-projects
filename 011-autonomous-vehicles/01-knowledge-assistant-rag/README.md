# Autonomous Vehicles — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **knowledge assistant with rag** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
