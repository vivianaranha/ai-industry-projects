# Autonomous Vehicles — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **intelligent classification and triage** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
