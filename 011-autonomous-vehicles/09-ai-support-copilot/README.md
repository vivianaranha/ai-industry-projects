# Autonomous Vehicles — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **ai support copilot** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
