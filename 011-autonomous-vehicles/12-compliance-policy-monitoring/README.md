# Autonomous Vehicles — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **compliance and policy monitoring** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
