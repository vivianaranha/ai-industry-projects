# Autonomous Vehicles — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **workforce planning and scheduling** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
