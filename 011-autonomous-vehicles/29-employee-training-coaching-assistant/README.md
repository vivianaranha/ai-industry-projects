# Autonomous Vehicles — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **autonomous-fleet operations** by applying **employee training and coaching assistant** to a realistic vehicle event. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Autonomous Vehicles
...
- Replace CSV sample data with approved Autonomous Vehicles data sources.
