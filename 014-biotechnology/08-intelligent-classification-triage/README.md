# Biotechnology — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **biotech operations** by applying **intelligent classification and triage** to a realistic experiment record. The user persona is typically a **scientist** or an employee supporting that workflow.
