# Biotechnology — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **biotech operations** by applying **compliance and policy monitoring** to a realistic experiment record. The user persona is typically a **scientist** or an employee supporting that workflow.
