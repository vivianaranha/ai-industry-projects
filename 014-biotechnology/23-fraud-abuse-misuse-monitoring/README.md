# Biotechnology — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **biotech operations** by applying **fraud abuse and misuse monitoring** to a realistic experiment record. The user persona is typically a **scientist** or an employee supporting that workflow.
