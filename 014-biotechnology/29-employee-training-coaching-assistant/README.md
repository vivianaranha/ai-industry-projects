# Biotechnology — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **biotech operations** by applying **employee training and coaching assistant** to a realistic experiment record. The user persona is typically a **scientist** or an employee supporting that workflow.
...
- Business outcome specific to Biotechnology
...
- Replace CSV sample data with approved Biotechnology data sources.
