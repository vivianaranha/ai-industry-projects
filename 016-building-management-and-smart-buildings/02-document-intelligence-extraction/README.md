# Building Management & Smart Buildings — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **document intelligence and extraction** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Extract structured fields, summarize documents, and flag missing information.
