# Building Management & Smart Buildings — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **demand and workload forecasting** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Forecast future demand or operational workload from historical observations.
...
```text
03-demand-workload-forecasting/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
