# Building Management & Smart Buildings — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **recommendation and next best action** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Recommend the next action, product, intervention, or operational choice.
...
```text
06-recommendation-next-best-action/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
