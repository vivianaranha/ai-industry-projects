# Building Management & Smart Buildings — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **intelligent classification and triage** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Classify incoming work and route it to the right queue or team.
...
```text
08-intelligent-classification-triage/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
