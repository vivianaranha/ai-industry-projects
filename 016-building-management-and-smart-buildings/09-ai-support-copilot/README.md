# Building Management & Smart Buildings — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **ai support copilot** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Assist users or employees with summaries, response drafts, and recommended actions.
