# Building Management & Smart Buildings — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **voice of customer and sentiment intelligence** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Classify feedback, detect themes, and identify urgent negative signals.
...
```text
14-voice-of-customer-sentiment/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
