# Building Management & Smart Buildings — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **pricing and revenue optimization** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Evaluate constrained choices to improve revenue, margin, or value delivery.
...
```text
15-pricing-revenue-optimization/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
