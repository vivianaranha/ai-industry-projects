# Building Management & Smart Buildings — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **workforce planning and scheduling** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Allocate limited workforce capacity to the highest-value work.
...
```text
16-workforce-planning-scheduling/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
