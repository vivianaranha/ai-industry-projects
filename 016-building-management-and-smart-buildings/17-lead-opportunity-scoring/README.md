# Building Management & Smart Buildings — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **lead and opportunity scoring** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Score opportunities and prioritize the records most likely to convert or create value.
