# Building Management & Smart Buildings — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **process bottleneck detection** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Analyze operational metrics to identify bottlenecks and likely root causes.
...
```text
18-process-bottleneck-detection/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
