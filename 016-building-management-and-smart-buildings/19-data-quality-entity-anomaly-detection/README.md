# Building Management & Smart Buildings — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **data quality and entity anomaly detection** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Identify unusual, incomplete, duplicate, or inconsistent business records.
...
```text
19-data-quality-entity-anomaly-detection/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
