# Building Management & Smart Buildings — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **predictive maintenance and asset health** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Estimate failure or service risk and prioritize preventive intervention.
...
```text
20-predictive-maintenance-asset-health/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
