# Building Management & Smart Buildings — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **incident response copilot** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Coordinate investigation steps and prepare a safe, human-approved response plan.
