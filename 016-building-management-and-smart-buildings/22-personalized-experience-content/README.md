# Building Management & Smart Buildings — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **personalized experience and content** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Recommend relevant experiences, content, products, or interventions.
...
```text
22-personalized-experience-content/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
