# Building Management & Smart Buildings — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **fraud abuse and misuse monitoring** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Detect suspicious behavior and route high-risk anomalies for investigation.
...
```text
23-fraud-abuse-misuse-monitoring/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
