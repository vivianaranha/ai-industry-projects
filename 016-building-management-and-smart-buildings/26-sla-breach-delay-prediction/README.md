# Building Management & Smart Buildings — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **sla breach and delay prediction** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Predict delay risk and prioritize records likely to miss service targets.
...
```text
26-sla-breach-delay-prediction/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
