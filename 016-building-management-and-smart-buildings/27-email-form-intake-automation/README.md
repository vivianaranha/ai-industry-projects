# Building Management & Smart Buildings — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **email form and intake automation** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Extract structured information from inbound text and identify missing fields.
...
```text
27-email-form-intake-automation/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
