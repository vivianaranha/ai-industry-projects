# Building Management & Smart Buildings — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **executive briefing generator** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Turn operational metrics into concise executive-level insights and follow-up questions.
...
```text
28-executive-briefing-generator/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
