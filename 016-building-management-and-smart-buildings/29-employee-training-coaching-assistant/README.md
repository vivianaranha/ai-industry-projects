# Building Management & Smart Buildings — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **building management & smart buildings operations** by applying **employee training and coaching assistant** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.

## What the Application Does

Ground training answers in approved knowledge and provide contextual guidance.
...
- Business outcome specific to Building Management & Smart Buildings

## Project Structure

```text
29-employee-training-coaching-assistant/
├── backend/
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py
...
- Replace CSV sample data with approved Building Management & Smart Buildings data sources.
