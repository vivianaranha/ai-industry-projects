# Childcare & Early Education — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **education operations** by applying **kpi insight and root cause analysis** to a realistic learning request. The user persona is typically a **learner** or an employee supporting that workflow.
