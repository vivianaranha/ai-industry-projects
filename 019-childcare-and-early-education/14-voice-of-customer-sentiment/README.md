# Childcare & Early Education — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **education operations** by applying **voice of customer and sentiment intelligence** to a realistic learning request. The user persona is typically a **learner** or an employee supporting that workflow.
