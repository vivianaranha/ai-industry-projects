# Childcare & Early Education — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **education operations** by applying **predictive maintenance and asset health** to a realistic learning request. The user persona is typically a **learner** or an employee supporting that workflow.
