# Childcare & Early Education — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **education operations** by applying **sla breach and delay prediction** to a realistic learning request. The user persona is typically a **learner** or an employee supporting that workflow.
