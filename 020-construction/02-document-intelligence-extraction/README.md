# Construction — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **document intelligence and extraction** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
