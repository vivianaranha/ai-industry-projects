# Construction — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **voice of customer and sentiment intelligence** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
