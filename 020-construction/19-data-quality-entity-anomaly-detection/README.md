# Construction — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **data quality and entity anomaly detection** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
