# Construction — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **personalized experience and content** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
