# Construction — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **capacity planning forecast** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
