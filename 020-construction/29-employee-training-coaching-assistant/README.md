# Construction — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **construction operations** by applying **employee training and coaching assistant** to a realistic project issue. The user persona is typically a **project manager** or an employee supporting that workflow.
...
- Business outcome specific to Construction
...
- Replace CSV sample data with approved Construction data sources.
