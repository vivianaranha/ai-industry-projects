# Consulting & Professional Services — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **consulting & professional services operations** by applying **audit and control testing assistant** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
