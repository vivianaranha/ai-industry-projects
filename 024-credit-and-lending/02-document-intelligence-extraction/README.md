# Credit & Lending — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **credit operations** by applying **document intelligence and extraction** to a realistic application. The user persona is typically a **borrower** or an employee supporting that workflow.
