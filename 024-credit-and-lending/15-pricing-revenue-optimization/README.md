# Credit & Lending — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **credit operations** by applying **pricing and revenue optimization** to a realistic application. The user persona is typically a **borrower** or an employee supporting that workflow.
