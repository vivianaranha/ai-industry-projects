# Credit & Lending — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **credit operations** by applying **incident response copilot** to a realistic application. The user persona is typically a **borrower** or an employee supporting that workflow.
