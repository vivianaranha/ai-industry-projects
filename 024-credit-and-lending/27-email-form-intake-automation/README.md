# Credit & Lending — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **credit operations** by applying **email form and intake automation** to a realistic application. The user persona is typically a **borrower** or an employee supporting that workflow.
