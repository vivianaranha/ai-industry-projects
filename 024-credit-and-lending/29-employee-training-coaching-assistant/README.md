# Credit & Lending — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **credit operations** by applying **employee training and coaching assistant** to a realistic application. The user persona is typically a **borrower** or an employee supporting that workflow.
...
- Business outcome specific to Credit & Lending
...
- Replace CSV sample data with approved Credit & Lending data sources.
