# Cybersecurity — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **security operations** by applying **knowledge assistant with rag** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
