...
This project demonstrates how AI can support **security operations** by applying **risk scoring and prioritization** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
