# Cybersecurity — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **security operations** by applying **lead and opportunity scoring** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
