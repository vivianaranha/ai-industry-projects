# Cybersecurity — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **security operations** by applying **personalized experience and content** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
