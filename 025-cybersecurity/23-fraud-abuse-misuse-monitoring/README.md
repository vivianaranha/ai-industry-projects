# Cybersecurity — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **security operations** by applying **fraud abuse and misuse monitoring** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
