# Cybersecurity — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **security operations** by applying **scenario planning and what-if analysis** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
