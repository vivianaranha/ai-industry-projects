# Cybersecurity — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **security operations** by applying **employee training and coaching assistant** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
...
- Business outcome specific to Cybersecurity
...
- Replace CSV sample data with approved Cybersecurity data sources.
