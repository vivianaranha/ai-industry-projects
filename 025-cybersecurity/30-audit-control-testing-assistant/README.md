# Cybersecurity — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **security operations** by applying **audit and control testing assistant** to a realistic security alert. The user persona is typically a **analyst** or an employee supporting that workflow.
