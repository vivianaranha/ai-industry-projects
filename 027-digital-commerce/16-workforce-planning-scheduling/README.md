# Digital Commerce — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **commerce operations** by applying **workforce planning and scheduling** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
