# Digital Commerce — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **commerce operations** by applying **email form and intake automation** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
