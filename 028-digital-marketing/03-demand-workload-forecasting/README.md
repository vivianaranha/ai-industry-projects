# Digital Marketing — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **demand and workload forecasting** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
