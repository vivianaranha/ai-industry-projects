# Digital Marketing — Operational Optimization

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **operational optimization** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
