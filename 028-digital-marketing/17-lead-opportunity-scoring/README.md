# Digital Marketing — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **lead and opportunity scoring** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
