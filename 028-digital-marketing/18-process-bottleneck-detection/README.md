# Digital Marketing — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **process bottleneck detection** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
