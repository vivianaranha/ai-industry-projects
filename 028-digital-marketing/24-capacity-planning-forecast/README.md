# Digital Marketing — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **capacity planning forecast** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
