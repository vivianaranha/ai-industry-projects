# Digital Marketing — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **scenario planning and what-if analysis** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
