# Digital Marketing — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **marketing operations** by applying **employee training and coaching assistant** to a realistic campaign interaction. The user persona is typically a **customer** or an employee supporting that workflow.
...
- Business outcome specific to Digital Marketing
...
- Replace CSV sample data with approved Digital Marketing data sources.
