# Drug Discovery & Pharmaceutical Research — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **pharma operations** by applying **knowledge assistant with rag** to a realistic study record. The user persona is typically a **researcher** or an employee supporting that workflow.
