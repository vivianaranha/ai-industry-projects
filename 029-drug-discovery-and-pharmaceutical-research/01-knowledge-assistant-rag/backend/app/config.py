...
class Settings:
    project_name: str = os.getenv("PROJECT_NAME", 'Drug Discovery & Pharmaceutical Research — Knowledge Assistant with RAG')
    industry: str = os.getenv("INDUSTRY", 'Drug Discovery & Pharmaceutical Research')
    use_case: str = os.getenv("USE_CASE", 'Knowledge Assistant with RAG')
