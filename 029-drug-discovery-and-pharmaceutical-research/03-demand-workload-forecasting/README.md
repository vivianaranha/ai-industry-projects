# Drug Discovery & Pharmaceutical Research — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **pharma operations** by applying **demand and workload forecasting** to a realistic study record. The user persona is typically a **researcher** or an employee supporting that workflow.
