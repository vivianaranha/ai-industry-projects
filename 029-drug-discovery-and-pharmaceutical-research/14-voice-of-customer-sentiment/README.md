# Drug Discovery & Pharmaceutical Research — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **pharma operations** by applying **voice of customer and sentiment intelligence** to a realistic study record. The user persona is typically a **researcher** or an employee supporting that workflow.
