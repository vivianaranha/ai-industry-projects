...
class Settings:
    project_name: str = os.getenv("PROJECT_NAME", 'Drug Discovery & Pharmaceutical Research — Workforce Planning and Scheduling')
    industry: str = os.getenv("INDUSTRY", 'Drug Discovery & Pharmaceutical Research')
    use_case: str = os.getenv("USE_CASE", 'Workforce Planning and Scheduling')
