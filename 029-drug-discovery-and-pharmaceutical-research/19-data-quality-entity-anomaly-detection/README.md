# Drug Discovery & Pharmaceutical Research — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **pharma operations** by applying **data quality and entity anomaly detection** to a realistic study record. The user persona is typically a **researcher** or an employee supporting that workflow.
