# Drug Discovery & Pharmaceutical Research — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **pharma operations** by applying **predictive maintenance and asset health** to a realistic study record. The user persona is typically a **researcher** or an employee supporting that workflow.
