...
class Settings:
    project_name: str = os.getenv("PROJECT_NAME", 'Drug Discovery & Pharmaceutical Research — Email Form and Intake Automation')
    industry: str = os.getenv("INDUSTRY", 'Drug Discovery & Pharmaceutical Research')
    use_case: str = os.getenv("USE_CASE", 'Email Form and Intake Automation')
