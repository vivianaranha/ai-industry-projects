# Electronics Manufacturing — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **plant operations** by applying **knowledge assistant with rag** to a realistic work order. The user persona is typically a **operator** or an employee supporting that workflow.
