# Electronics Manufacturing — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **plant operations** by applying **lead and opportunity scoring** to a realistic work order. The user persona is typically a **operator** or an employee supporting that workflow.
