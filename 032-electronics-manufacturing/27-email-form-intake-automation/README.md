# Electronics Manufacturing — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **plant operations** by applying **email form and intake automation** to a realistic work order. The user persona is typically a **operator** or an employee supporting that workflow.
