# Electronics Manufacturing — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **plant operations** by applying **employee training and coaching assistant** to a realistic work order. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Electronics Manufacturing
...
- Replace CSV sample data with approved Electronics Manufacturing data sources.
