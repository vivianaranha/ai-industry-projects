# Engineering Services — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **engineering services operations** by applying **personalized experience and content** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
