# Environmental Services — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **environmental services operations** by applying **document intelligence and extraction** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
