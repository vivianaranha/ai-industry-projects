# FinTech — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **fintech operations** by applying **knowledge assistant with rag** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
