# Fisheries & Aquaculture — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **aquaculture operations** by applying **recommendation and next best action** to a realistic harvest record. The user persona is typically a **operator** or an employee supporting that workflow.
