# Fisheries & Aquaculture — Operational Optimization

## Business Problem

This project demonstrates how AI can support **aquaculture operations** by applying **operational optimization** to a realistic harvest record. The user persona is typically a **operator** or an employee supporting that workflow.
