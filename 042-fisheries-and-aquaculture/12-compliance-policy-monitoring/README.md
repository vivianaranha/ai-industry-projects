# Fisheries & Aquaculture — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **aquaculture operations** by applying **compliance and policy monitoring** to a realistic harvest record. The user persona is typically a **operator** or an employee supporting that workflow.
