# Fisheries & Aquaculture — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **aquaculture operations** by applying **incident response copilot** to a realistic harvest record. The user persona is typically a **operator** or an employee supporting that workflow.
