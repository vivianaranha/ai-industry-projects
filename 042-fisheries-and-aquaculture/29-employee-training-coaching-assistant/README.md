# Fisheries & Aquaculture — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **aquaculture operations** by applying **employee training and coaching assistant** to a realistic harvest record. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Fisheries & Aquaculture
...
- Replace CSV sample data with approved Fisheries & Aquaculture data sources.
