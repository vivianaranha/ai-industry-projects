# Fitness & Wellness — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **fitness & wellness operations** by applying **recommendation and next best action** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
