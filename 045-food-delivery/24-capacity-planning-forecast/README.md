# Food Delivery — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **food delivery operations** by applying **capacity planning forecast** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
