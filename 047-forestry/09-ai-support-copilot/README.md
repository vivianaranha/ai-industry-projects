# Forestry — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **forestry operations** by applying **ai support copilot** to a realistic forest record. The user persona is typically a **operator** or an employee supporting that workflow.
