# Forestry — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **forestry operations** by applying **compliance and policy monitoring** to a realistic forest record. The user persona is typically a **operator** or an employee supporting that workflow.
