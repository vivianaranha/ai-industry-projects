# Forestry — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **forestry operations** by applying **employee training and coaching assistant** to a realistic forest record. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Forestry
...
- Replace CSV sample data with approved Forestry data sources.
