# Forestry — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **forestry operations** by applying **audit and control testing assistant** to a realistic forest record. The user persona is typically a **operator** or an employee supporting that workflow.
