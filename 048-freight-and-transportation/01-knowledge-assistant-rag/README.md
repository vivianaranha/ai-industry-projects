# Freight & Transportation — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **freight operations** by applying **knowledge assistant with rag** to a realistic load. The user persona is typically a **shipper** or an employee supporting that workflow.
