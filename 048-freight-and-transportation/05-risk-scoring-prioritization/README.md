# Freight & Transportation — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **freight operations** by applying **risk scoring and prioritization** to a realistic load. The user persona is typically a **shipper** or an employee supporting that workflow.
