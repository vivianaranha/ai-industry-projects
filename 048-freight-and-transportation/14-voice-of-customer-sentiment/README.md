# Freight & Transportation — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **freight operations** by applying **voice of customer and sentiment intelligence** to a realistic load. The user persona is typically a **shipper** or an employee supporting that workflow.
