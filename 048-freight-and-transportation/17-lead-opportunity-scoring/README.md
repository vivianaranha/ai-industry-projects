# Freight & Transportation — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **freight operations** by applying **lead and opportunity scoring** to a realistic load. The user persona is typically a **shipper** or an employee supporting that workflow.
