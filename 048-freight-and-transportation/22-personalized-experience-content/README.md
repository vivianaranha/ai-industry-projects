# Freight & Transportation — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **freight operations** by applying **personalized experience and content** to a realistic load. The user persona is typically a **shipper** or an employee supporting that workflow.
