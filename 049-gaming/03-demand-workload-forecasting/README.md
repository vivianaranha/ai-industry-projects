# Gaming — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **live-game operations** by applying **demand and workload forecasting** to a realistic game event. The user persona is typically a **player** or an employee supporting that workflow.
