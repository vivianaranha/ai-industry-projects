# Gaming — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **live-game operations** by applying **pricing and revenue optimization** to a realistic game event. The user persona is typically a **player** or an employee supporting that workflow.
