# Gaming — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **live-game operations** by applying **data quality and entity anomaly detection** to a realistic game event. The user persona is typically a **player** or an employee supporting that workflow.
