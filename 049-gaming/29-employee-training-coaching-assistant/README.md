# Gaming — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **live-game operations** by applying **employee training and coaching assistant** to a realistic game event. The user persona is typically a **player** or an employee supporting that workflow.
...
- Business outcome specific to Gaming
...
- Replace CSV sample data with approved Gaming data sources.
