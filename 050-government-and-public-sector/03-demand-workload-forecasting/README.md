# Government & Public Sector — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **demand and workload forecasting** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
