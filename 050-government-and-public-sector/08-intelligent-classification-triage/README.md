# Government & Public Sector — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **intelligent classification and triage** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
