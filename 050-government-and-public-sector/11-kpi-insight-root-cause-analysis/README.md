# Government & Public Sector — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **kpi insight and root cause analysis** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
