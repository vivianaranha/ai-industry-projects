# Government & Public Sector — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **lead and opportunity scoring** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
