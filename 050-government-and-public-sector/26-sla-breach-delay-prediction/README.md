# Government & Public Sector — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **sla breach and delay prediction** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
