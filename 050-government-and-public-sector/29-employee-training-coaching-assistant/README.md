# Government & Public Sector — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **employee training and coaching assistant** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
...
- Business outcome specific to Government & Public Sector
...
- Replace CSV sample data with approved Government & Public Sector data sources.
