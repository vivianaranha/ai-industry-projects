# Government & Public Sector — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **public-sector operations** by applying **audit and control testing assistant** to a realistic service request. The user persona is typically a **resident** or an employee supporting that workflow.
