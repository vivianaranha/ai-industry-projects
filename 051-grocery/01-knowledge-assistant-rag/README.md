# Grocery — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **store operations** by applying **knowledge assistant with rag** to a realistic basket. The user persona is typically a **shopper** or an employee supporting that workflow.
