# Grocery — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **store operations** by applying **risk scoring and prioritization** to a realistic basket. The user persona is typically a **shopper** or an employee supporting that workflow.
