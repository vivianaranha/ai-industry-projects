# Grocery — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **store operations** by applying **kpi insight and root cause analysis** to a realistic basket. The user persona is typically a **shopper** or an employee supporting that workflow.
