# Grocery — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **store operations** by applying **compliance and policy monitoring** to a realistic basket. The user persona is typically a **shopper** or an employee supporting that workflow.
