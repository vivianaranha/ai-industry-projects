# Grocery — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **store operations** by applying **employee training and coaching assistant** to a realistic basket. The user persona is typically a **shopper** or an employee supporting that workflow.
...
- Business outcome specific to Grocery
...
- Replace CSV sample data with approved Grocery data sources.
