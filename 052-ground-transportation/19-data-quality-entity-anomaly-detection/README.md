# Ground Transportation — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **ground transportation operations** by applying **data quality and entity anomaly detection** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
