# Ground Transportation — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **ground transportation operations** by applying **scenario planning and what-if analysis** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
