# Health Insurance — Operational Optimization

## Business Problem

This project demonstrates how AI can support **care management** by applying **operational optimization** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
