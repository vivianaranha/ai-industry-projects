# Health Insurance — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **care management** by applying **intelligent classification and triage** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
