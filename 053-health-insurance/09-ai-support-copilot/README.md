# Health Insurance — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **care management** by applying **ai support copilot** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
