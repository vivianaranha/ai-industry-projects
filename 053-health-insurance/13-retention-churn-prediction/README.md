# Health Insurance — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **care management** by applying **retention and churn prediction** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
