# Health Insurance — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **care management** by applying **executive briefing generator** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
