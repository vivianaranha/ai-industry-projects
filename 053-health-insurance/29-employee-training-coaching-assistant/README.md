# Health Insurance — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **care management** by applying **employee training and coaching assistant** to a realistic claim. The user persona is typically a **member** or an employee supporting that workflow.
...
- Business outcome specific to Health Insurance
...
- Replace CSV sample data with approved Health Insurance data sources.
