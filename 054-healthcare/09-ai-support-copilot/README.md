# Healthcare — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **clinical operations** by applying **ai support copilot** to a realistic care case. The user persona is typically a **patient** or an employee supporting that workflow.
