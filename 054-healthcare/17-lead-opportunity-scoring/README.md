# Healthcare — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **clinical operations** by applying **lead and opportunity scoring** to a realistic care case. The user persona is typically a **patient** or an employee supporting that workflow.
