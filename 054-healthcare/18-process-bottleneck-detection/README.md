# Healthcare — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **clinical operations** by applying **process bottleneck detection** to a realistic care case. The user persona is typically a **patient** or an employee supporting that workflow.
