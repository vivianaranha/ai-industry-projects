# Healthcare — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **clinical operations** by applying **email form and intake automation** to a realistic care case. The user persona is typically a **patient** or an employee supporting that workflow.
