# Healthcare — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **clinical operations** by applying **employee training and coaching assistant** to a realistic care case. The user persona is typically a **patient** or an employee supporting that workflow.
...
- Business outcome specific to Healthcare
...
- Replace CSV sample data with approved Healthcare data sources.
