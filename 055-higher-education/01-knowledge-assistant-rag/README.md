# Higher Education — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **knowledge assistant with rag** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
