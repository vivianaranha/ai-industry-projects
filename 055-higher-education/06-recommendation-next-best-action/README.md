# Higher Education — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **recommendation and next best action** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
