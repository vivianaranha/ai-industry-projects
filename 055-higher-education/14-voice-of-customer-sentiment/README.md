# Higher Education — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **voice of customer and sentiment intelligence** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
