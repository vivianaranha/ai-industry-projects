# Higher Education — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **incident response copilot** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
