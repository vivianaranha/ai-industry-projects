# Higher Education — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **sla breach and delay prediction** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
