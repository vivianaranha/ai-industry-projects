# Higher Education — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **academic operations** by applying **employee training and coaching assistant** to a realistic student case. The user persona is typically a **student** or an employee supporting that workflow.
...
- Business outcome specific to Higher Education
...
- Replace CSV sample data with approved Higher Education data sources.
