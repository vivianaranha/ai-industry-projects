# Hospitality — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **demand and workload forecasting** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
