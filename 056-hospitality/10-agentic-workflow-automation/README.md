# Hospitality — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **agentic workflow automation** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
