# Hospitality — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **compliance and policy monitoring** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
