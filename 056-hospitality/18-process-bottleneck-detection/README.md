# Hospitality — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **process bottleneck detection** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
