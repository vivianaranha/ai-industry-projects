# Hospitality — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **fraud abuse and misuse monitoring** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
