# Hospitality — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **hospitality operations** by applying **employee training and coaching assistant** to a realistic service request. The user persona is typically a **guest** or an employee supporting that workflow.
...
- Business outcome specific to Hospitality
...
- Replace CSV sample data with approved Hospitality data sources.
