# Hotels & Resorts — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **demand and workload forecasting** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
