# Hotels & Resorts — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **ai support copilot** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
