# Hotels & Resorts — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **workforce planning and scheduling** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
