# Hotels & Resorts — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **fraud abuse and misuse monitoring** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
