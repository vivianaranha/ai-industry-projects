# Hotels & Resorts — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **email form and intake automation** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
