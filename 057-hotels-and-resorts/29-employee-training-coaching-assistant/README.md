# Hotels & Resorts — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **hotel operations** by applying **employee training and coaching assistant** to a realistic reservation. The user persona is typically a **guest** or an employee supporting that workflow.
...
- Business outcome specific to Hotels & Resorts
...
- Replace CSV sample data with approved Hotels & Resorts data sources.
