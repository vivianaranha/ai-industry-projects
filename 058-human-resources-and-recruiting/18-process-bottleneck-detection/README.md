# Human Resources & Recruiting — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **people operations** by applying **process bottleneck detection** to a realistic HR case. The user persona is typically a **employee** or an employee supporting that workflow.
