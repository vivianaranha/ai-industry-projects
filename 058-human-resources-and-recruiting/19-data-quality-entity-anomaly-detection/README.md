# Human Resources & Recruiting — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **people operations** by applying **data quality and entity anomaly detection** to a realistic HR case. The user persona is typically a **employee** or an employee supporting that workflow.
