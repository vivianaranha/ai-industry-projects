# Human Resources & Recruiting — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **people operations** by applying **fraud abuse and misuse monitoring** to a realistic HR case. The user persona is typically a **employee** or an employee supporting that workflow.
