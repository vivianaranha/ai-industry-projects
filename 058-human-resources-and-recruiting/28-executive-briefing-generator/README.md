# Human Resources & Recruiting — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **people operations** by applying **executive briefing generator** to a realistic HR case. The user persona is typically a **employee** or an employee supporting that workflow.
