# Human Resources & Recruiting — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **people operations** by applying **audit and control testing assistant** to a realistic HR case. The user persona is typically a **employee** or an employee supporting that workflow.
