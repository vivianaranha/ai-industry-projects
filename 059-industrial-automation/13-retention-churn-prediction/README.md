# Industrial Automation — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **industrial automation operations** by applying **retention and churn prediction** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
