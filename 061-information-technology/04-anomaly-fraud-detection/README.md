# Information Technology — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **anomaly and fraud detection** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
