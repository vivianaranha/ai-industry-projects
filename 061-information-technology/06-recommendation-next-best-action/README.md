# Information Technology — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **recommendation and next best action** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
