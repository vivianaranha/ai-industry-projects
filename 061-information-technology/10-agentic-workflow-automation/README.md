# Information Technology — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **agentic workflow automation** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
