# Information Technology — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **lead and opportunity scoring** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
