# Information Technology — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **incident response copilot** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
