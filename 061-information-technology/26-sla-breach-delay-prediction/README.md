# Information Technology — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **sla breach and delay prediction** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
