# Information Technology — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **IT operations** by applying **employee training and coaching assistant** to a realistic service ticket. The user persona is typically a **employee** or an employee supporting that workflow.
...
- Business outcome specific to Information Technology
...
- Replace CSV sample data with approved Information Technology data sources.
