# Insurance — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **ai support copilot** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
