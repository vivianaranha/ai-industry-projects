# Insurance — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **compliance and policy monitoring** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
