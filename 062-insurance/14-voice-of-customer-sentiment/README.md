# Insurance — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **voice of customer and sentiment intelligence** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
