# Insurance — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **process bottleneck detection** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
