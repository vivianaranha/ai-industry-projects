# Insurance — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **data quality and entity anomaly detection** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
