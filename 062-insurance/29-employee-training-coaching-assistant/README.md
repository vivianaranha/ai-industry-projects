# Insurance — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **insurance operations** by applying **employee training and coaching assistant** to a realistic claim. The user persona is typically a **policyholder** or an employee supporting that workflow.
...
- Business outcome specific to Insurance
...
- Replace CSV sample data with approved Insurance data sources.
