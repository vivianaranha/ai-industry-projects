# Interior Design — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **interior design operations** by applying **compliance and policy monitoring** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
