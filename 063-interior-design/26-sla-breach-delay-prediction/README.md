# Interior Design — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **interior design operations** by applying **sla breach and delay prediction** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
