# Investment Banking — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **banking operations** by applying **intelligent classification and triage** to a realistic transaction. The user persona is typically a **customer** or an employee supporting that workflow.
