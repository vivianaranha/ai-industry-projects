# Investment Banking — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **banking operations** by applying **workforce planning and scheduling** to a realistic transaction. The user persona is typically a **customer** or an employee supporting that workflow.
