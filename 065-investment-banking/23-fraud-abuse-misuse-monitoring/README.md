# Investment Banking — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **banking operations** by applying **fraud abuse and misuse monitoring** to a realistic transaction. The user persona is typically a **customer** or an employee supporting that workflow.
