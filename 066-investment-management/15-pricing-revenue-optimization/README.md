# Investment Management — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **pricing and revenue optimization** to a realistic portfolio event. The user persona is typically a **investor** or an employee supporting that workflow.
