# Investment Management — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **workforce planning and scheduling** to a realistic portfolio event. The user persona is typically a **investor** or an employee supporting that workflow.
