# Investment Management — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **data quality and entity anomaly detection** to a realistic portfolio event. The user persona is typically a **investor** or an employee supporting that workflow.
