# Investment Management — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **employee training and coaching assistant** to a realistic portfolio event. The user persona is typically a **investor** or an employee supporting that workflow.
...
- Business outcome specific to Investment Management
...
- Replace CSV sample data with approved Investment Management data sources.
