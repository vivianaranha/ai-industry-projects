# Investment Management — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **audit and control testing assistant** to a realistic portfolio event. The user persona is typically a **investor** or an employee supporting that workflow.
