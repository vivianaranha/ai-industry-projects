# Journalism & News Media — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **media operations** by applying **knowledge assistant with rag** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
