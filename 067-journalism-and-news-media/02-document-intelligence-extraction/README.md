# Journalism & News Media — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **media operations** by applying **document intelligence and extraction** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
