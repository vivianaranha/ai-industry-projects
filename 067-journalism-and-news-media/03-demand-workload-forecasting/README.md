# Journalism & News Media — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **media operations** by applying **demand and workload forecasting** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
