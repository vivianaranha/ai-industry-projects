# Journalism & News Media — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **media operations** by applying **anomaly and fraud detection** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
