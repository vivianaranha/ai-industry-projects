# Journalism & News Media — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **media operations** by applying **risk scoring and prioritization** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
