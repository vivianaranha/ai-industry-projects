# Journalism & News Media — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **media operations** by applying **recommendation and next best action** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
