# Journalism & News Media — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **media operations** by applying **intelligent classification and triage** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
