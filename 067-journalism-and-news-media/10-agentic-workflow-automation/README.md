# Journalism & News Media — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **media operations** by applying **agentic workflow automation** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
