# Journalism & News Media — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **media operations** by applying **kpi insight and root cause analysis** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
