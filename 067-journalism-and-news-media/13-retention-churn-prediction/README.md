# Journalism & News Media — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **media operations** by applying **retention and churn prediction** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
