# Journalism & News Media — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **media operations** by applying **voice of customer and sentiment intelligence** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
