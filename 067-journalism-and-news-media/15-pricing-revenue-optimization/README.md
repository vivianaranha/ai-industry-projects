# Journalism & News Media — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **media operations** by applying **pricing and revenue optimization** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
