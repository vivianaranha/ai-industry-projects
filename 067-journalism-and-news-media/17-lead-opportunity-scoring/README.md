# Journalism & News Media — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **media operations** by applying **lead and opportunity scoring** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
