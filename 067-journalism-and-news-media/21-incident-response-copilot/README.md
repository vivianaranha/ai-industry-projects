# Journalism & News Media — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **media operations** by applying **incident response copilot** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
