# Journalism & News Media — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **media operations** by applying **personalized experience and content** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
