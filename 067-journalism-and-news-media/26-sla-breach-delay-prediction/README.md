# Journalism & News Media — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **media operations** by applying **sla breach and delay prediction** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
