# Journalism & News Media — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **media operations** by applying **email form and intake automation** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
