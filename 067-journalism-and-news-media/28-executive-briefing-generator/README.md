# Journalism & News Media — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **media operations** by applying **executive briefing generator** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
