# Journalism & News Media — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **media operations** by applying **employee training and coaching assistant** to a realistic content item. The user persona is typically a **audience member** or an employee supporting that workflow.
...
- Business outcome specific to Journalism & News Media
...
- Replace CSV sample data with approved Journalism & News Media data sources.
