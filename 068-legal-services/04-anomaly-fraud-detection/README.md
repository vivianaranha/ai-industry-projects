# Legal Services — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **legal operations** by applying **anomaly and fraud detection** to a realistic matter. The user persona is typically a **client** or an employee supporting that workflow.
