# Legal Services — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **legal operations** by applying **recommendation and next best action** to a realistic matter. The user persona is typically a **client** or an employee supporting that workflow.
