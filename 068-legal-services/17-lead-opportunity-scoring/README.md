# Legal Services — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **legal operations** by applying **lead and opportunity scoring** to a realistic matter. The user persona is typically a **client** or an employee supporting that workflow.
