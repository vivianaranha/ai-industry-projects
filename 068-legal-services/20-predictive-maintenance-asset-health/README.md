# Legal Services — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **legal operations** by applying **predictive maintenance and asset health** to a realistic matter. The user persona is typically a **client** or an employee supporting that workflow.
