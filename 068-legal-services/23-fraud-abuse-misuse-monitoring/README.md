# Legal Services — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **legal operations** by applying **fraud abuse and misuse monitoring** to a realistic matter. The user persona is typically a **client** or an employee supporting that workflow.
