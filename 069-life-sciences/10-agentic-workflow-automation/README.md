# Life Sciences — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **agentic workflow automation** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
