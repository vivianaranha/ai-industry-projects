# Life Sciences — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **kpi insight and root cause analysis** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
