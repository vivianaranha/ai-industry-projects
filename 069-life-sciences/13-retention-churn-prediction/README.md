# Life Sciences — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **retention and churn prediction** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
