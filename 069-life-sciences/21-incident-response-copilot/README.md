# Life Sciences — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **incident response copilot** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
