# Life Sciences — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **fraud abuse and misuse monitoring** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
