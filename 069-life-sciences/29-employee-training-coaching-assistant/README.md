# Life Sciences — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **life-science operations** by applying **employee training and coaching assistant** to a realistic study record. The user persona is typically a **scientist** or an employee supporting that workflow.
...
- Business outcome specific to Life Sciences
...
- Replace CSV sample data with approved Life Sciences data sources.
