...
This project demonstrates how AI can support **logistics operations** by applying **operational optimization** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
