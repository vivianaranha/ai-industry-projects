# Logistics — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **logistics operations** by applying **retention and churn prediction** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
