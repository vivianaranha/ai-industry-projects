# Logistics — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **logistics operations** by applying **voice of customer and sentiment intelligence** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
