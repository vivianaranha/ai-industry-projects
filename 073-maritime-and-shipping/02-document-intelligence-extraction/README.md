# Maritime & Shipping — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **shipping operations** by applying **document intelligence and extraction** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
