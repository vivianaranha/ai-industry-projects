# Maritime & Shipping — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **shipping operations** by applying **intelligent classification and triage** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
