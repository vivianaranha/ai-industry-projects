# Maritime & Shipping — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **shipping operations** by applying **lead and opportunity scoring** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
