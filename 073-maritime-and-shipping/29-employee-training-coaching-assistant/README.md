# Maritime & Shipping — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **shipping operations** by applying **employee training and coaching assistant** to a realistic shipment. The user persona is typically a **shipper** or an employee supporting that workflow.
...
- Business outcome specific to Maritime & Shipping
...
- Replace CSV sample data with approved Maritime & Shipping data sources.
