# Medical Devices — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **device operations** by applying **demand and workload forecasting** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
