# Medical Devices — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **device operations** by applying **risk scoring and prioritization** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
