# Medical Devices — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **device operations** by applying **process bottleneck detection** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
