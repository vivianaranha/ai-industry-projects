# Medical Devices — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **device operations** by applying **predictive maintenance and asset health** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
