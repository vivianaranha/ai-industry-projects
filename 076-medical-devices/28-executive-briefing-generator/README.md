# Medical Devices — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **device operations** by applying **executive briefing generator** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
