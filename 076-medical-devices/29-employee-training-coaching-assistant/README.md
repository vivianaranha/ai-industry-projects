# Medical Devices — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **device operations** by applying **employee training and coaching assistant** to a realistic device event. The user persona is typically a **clinician** or an employee supporting that workflow.
...
- Business outcome specific to Medical Devices
...
- Replace CSV sample data with approved Medical Devices data sources.
