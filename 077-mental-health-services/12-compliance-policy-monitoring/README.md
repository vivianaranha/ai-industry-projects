# Mental Health Services — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **mental health services operations** by applying **compliance and policy monitoring** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
