# Metals & Mining — Fraud Abuse and Misuse Monitoring

## Business Problem

This project demonstrates how AI can support **metals & mining operations** by applying **fraud abuse and misuse monitoring** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
