# Military & Defense — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **defense operations** by applying **knowledge assistant with rag** to a realistic mission record. The user persona is typically a **operator** or an employee supporting that workflow.
