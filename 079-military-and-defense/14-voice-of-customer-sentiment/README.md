# Military & Defense — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **defense operations** by applying **voice of customer and sentiment intelligence** to a realistic mission record. The user persona is typically a **operator** or an employee supporting that workflow.
