# Military & Defense — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **defense operations** by applying **lead and opportunity scoring** to a realistic mission record. The user persona is typically a **operator** or an employee supporting that workflow.
