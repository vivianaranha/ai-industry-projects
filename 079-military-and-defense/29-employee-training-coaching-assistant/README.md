# Military & Defense — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **defense operations** by applying **employee training and coaching assistant** to a realistic mission record. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Military & Defense
...
- Replace CSV sample data with approved Military & Defense data sources.
