# Military & Defense — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **defense operations** by applying **audit and control testing assistant** to a realistic mission record. The user persona is typically a **operator** or an employee supporting that workflow.
