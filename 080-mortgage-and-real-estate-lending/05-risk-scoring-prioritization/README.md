# Mortgage & Real Estate Lending — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **risk scoring and prioritization** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
