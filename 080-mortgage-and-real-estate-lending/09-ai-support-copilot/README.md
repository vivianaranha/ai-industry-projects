# Mortgage & Real Estate Lending — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **ai support copilot** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
