# Mortgage & Real Estate Lending — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **agentic workflow automation** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
