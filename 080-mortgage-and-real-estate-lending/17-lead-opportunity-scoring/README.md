# Mortgage & Real Estate Lending — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **lead and opportunity scoring** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
