# Mortgage & Real Estate Lending — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **sla breach and delay prediction** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
