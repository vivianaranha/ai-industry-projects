# Mortgage & Real Estate Lending — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **mortgage operations** by applying **employee training and coaching assistant** to a realistic loan file. The user persona is typically a **borrower** or an employee supporting that workflow.
...
- Business outcome specific to Mortgage & Real Estate Lending
...
- Replace CSV sample data with approved Mortgage & Real Estate Lending data sources.
