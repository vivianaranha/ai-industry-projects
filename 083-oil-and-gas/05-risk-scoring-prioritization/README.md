# Oil & Gas — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **field operations** by applying **risk scoring and prioritization** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
