# Oil & Gas — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **field operations** by applying **ai support copilot** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
