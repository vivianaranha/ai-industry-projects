# Oil & Gas — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **field operations** by applying **sla breach and delay prediction** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
