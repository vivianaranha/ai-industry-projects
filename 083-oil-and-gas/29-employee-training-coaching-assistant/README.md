# Oil & Gas — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **field operations** by applying **employee training and coaching assistant** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Oil & Gas
...
- Replace CSV sample data with approved Oil & Gas data sources.
