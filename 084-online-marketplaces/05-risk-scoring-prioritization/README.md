# Online Marketplaces — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **online marketplaces operations** by applying **risk scoring and prioritization** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
