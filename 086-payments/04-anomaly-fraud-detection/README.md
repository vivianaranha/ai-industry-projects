# Payments — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **payment operations** by applying **anomaly and fraud detection** to a realistic payment. The user persona is typically a **merchant** or an employee supporting that workflow.
