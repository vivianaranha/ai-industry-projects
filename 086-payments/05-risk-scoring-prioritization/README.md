# Payments — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **payment operations** by applying **risk scoring and prioritization** to a realistic payment. The user persona is typically a **merchant** or an employee supporting that workflow.
