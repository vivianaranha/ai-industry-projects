# Payments — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **payment operations** by applying **lead and opportunity scoring** to a realistic payment. The user persona is typically a **merchant** or an employee supporting that workflow.
