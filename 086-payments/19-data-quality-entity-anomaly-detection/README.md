# Payments — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **payment operations** by applying **data quality and entity anomaly detection** to a realistic payment. The user persona is typically a **merchant** or an employee supporting that workflow.
