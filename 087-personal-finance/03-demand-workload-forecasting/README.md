# Personal Finance — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **personal finance operations** by applying **demand and workload forecasting** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
