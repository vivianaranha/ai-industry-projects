# Quantum Computing — Operational Optimization

## Business Problem

This project demonstrates how AI can support **quantum computing operations** by applying **operational optimization** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
