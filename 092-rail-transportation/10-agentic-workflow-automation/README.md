# Rail Transportation — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **rail transportation operations** by applying **agentic workflow automation** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
