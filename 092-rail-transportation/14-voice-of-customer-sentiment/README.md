# Rail Transportation — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **rail transportation operations** by applying **voice of customer and sentiment intelligence** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
