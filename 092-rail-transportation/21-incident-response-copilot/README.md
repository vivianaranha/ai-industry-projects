# Rail Transportation — Incident Response Copilot

## Business Problem

This project demonstrates how AI can support **rail transportation operations** by applying **incident response copilot** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
