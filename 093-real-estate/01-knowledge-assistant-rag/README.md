# Real Estate — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **knowledge assistant with rag** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
