# Real Estate — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **recommendation and next best action** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
