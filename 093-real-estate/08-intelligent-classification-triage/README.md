# Real Estate — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **intelligent classification and triage** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
