# Real Estate — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **voice of customer and sentiment intelligence** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
