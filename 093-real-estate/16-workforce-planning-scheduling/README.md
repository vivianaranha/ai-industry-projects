# Real Estate — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **workforce planning and scheduling** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
