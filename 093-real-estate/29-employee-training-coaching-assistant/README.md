# Real Estate — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **real-estate operations** by applying **employee training and coaching assistant** to a realistic property. The user persona is typically a **client** or an employee supporting that workflow.
...
- Business outcome specific to Real Estate
...
- Replace CSV sample data with approved Real Estate data sources.
