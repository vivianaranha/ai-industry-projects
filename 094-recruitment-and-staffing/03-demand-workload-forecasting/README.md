# Recruitment & Staffing — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **demand and workload forecasting** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
