# Recruitment & Staffing — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **risk scoring and prioritization** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
