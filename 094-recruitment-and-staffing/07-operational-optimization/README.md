# Recruitment & Staffing — Operational Optimization

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **operational optimization** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
