# Recruitment & Staffing — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **lead and opportunity scoring** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
