# Recruitment & Staffing — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **predictive maintenance and asset health** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
