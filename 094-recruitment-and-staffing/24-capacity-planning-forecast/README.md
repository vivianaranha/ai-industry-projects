# Recruitment & Staffing — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **talent operations** by applying **capacity planning forecast** to a realistic application. The user persona is typically a **candidate** or an employee supporting that workflow.
