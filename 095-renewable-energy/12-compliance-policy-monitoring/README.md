# Renewable Energy — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **energy operations** by applying **compliance and policy monitoring** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
