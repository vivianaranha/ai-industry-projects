# Renewable Energy — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **energy operations** by applying **scenario planning and what-if analysis** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
