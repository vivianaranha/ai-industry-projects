# Renewable Energy — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **energy operations** by applying **employee training and coaching assistant** to a realistic asset event. The user persona is typically a **operator** or an employee supporting that workflow.
...
- Business outcome specific to Renewable Energy
...
- Replace CSV sample data with approved Renewable Energy data sources.
