# Restaurants — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **demand and workload forecasting** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
