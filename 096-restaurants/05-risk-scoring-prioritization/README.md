# Restaurants — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **risk scoring and prioritization** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
