# Restaurants — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **intelligent classification and triage** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
