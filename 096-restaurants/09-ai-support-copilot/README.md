# Restaurants — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **ai support copilot** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
