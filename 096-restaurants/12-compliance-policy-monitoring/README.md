# Restaurants — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **compliance and policy monitoring** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
