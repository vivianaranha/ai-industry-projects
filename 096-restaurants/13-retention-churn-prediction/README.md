# Restaurants — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **retention and churn prediction** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
