# Restaurants — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **voice of customer and sentiment intelligence** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
