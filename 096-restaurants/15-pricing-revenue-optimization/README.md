# Restaurants — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **pricing and revenue optimization** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
