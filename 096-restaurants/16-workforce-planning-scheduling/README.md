# Restaurants — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **workforce planning and scheduling** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
