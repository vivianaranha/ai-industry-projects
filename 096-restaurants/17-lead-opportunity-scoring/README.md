# Restaurants — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **lead and opportunity scoring** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
