# Restaurants — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **data quality and entity anomaly detection** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
