# Restaurants — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **personalized experience and content** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
