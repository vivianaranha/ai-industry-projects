# Restaurants — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **capacity planning forecast** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
