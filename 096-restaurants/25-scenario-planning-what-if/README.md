# Restaurants — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **scenario planning and what-if analysis** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
