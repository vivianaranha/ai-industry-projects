# Restaurants — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **sla breach and delay prediction** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
