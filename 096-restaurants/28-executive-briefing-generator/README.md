# Restaurants — Executive Briefing Generator

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **executive briefing generator** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
