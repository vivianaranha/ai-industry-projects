# Restaurants — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **employee training and coaching assistant** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
...
- Business outcome specific to Restaurants
...
- Replace CSV sample data with approved Restaurants data sources.
