# Restaurants — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **restaurant operations** by applying **audit and control testing assistant** to a realistic order. The user persona is typically a **guest** or an employee supporting that workflow.
