# Retail — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **retail operations** by applying **document intelligence and extraction** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
