# Retail — Operational Optimization

## Business Problem

This project demonstrates how AI can support **retail operations** by applying **operational optimization** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
