# Retail — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **retail operations** by applying **process bottleneck detection** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
