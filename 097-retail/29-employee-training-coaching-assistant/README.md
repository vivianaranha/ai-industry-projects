# Retail — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **retail operations** by applying **employee training and coaching assistant** to a realistic order. The user persona is typically a **shopper** or an employee supporting that workflow.
...
- Business outcome specific to Retail
...
- Replace CSV sample data with approved Retail data sources.
