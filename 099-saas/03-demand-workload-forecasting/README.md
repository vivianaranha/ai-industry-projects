# SaaS — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **SaaS operations** by applying **demand and workload forecasting** to a realistic account event. The user persona is typically a **customer** or an employee supporting that workflow.
