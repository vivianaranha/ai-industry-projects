# SaaS — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **SaaS operations** by applying **kpi insight and root cause analysis** to a realistic account event. The user persona is typically a **customer** or an employee supporting that workflow.
