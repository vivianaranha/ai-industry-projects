# SaaS — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **SaaS operations** by applying **audit and control testing assistant** to a realistic account event. The user persona is typically a **customer** or an employee supporting that workflow.
