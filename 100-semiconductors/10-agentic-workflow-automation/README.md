# Semiconductors — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **fab operations** by applying **agentic workflow automation** to a realistic wafer lot. The user persona is typically a **engineer** or an employee supporting that workflow.
