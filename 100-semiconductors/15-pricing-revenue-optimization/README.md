# Semiconductors — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **fab operations** by applying **pricing and revenue optimization** to a realistic wafer lot. The user persona is typically a **engineer** or an employee supporting that workflow.
