# Semiconductors — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **fab operations** by applying **lead and opportunity scoring** to a realistic wafer lot. The user persona is typically a **engineer** or an employee supporting that workflow.
