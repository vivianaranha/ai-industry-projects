# Semiconductors — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **fab operations** by applying **data quality and entity anomaly detection** to a realistic wafer lot. The user persona is typically a **engineer** or an employee supporting that workflow.
