# Semiconductors — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **fab operations** by applying **employee training and coaching assistant** to a realistic wafer lot. The user persona is typically a **engineer** or an employee supporting that workflow.
...
- Business outcome specific to Semiconductors
...
- Replace CSV sample data with approved Semiconductors data sources.
