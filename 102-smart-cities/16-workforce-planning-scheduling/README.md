# Smart Cities — Workforce Planning and Scheduling

## Business Problem

This project demonstrates how AI can support **smart cities operations** by applying **workforce planning and scheduling** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
