# Smart Cities — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **smart cities operations** by applying **email form and intake automation** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
