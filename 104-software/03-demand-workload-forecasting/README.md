# Software — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **software operations** by applying **demand and workload forecasting** to a realistic product issue. The user persona is typically a **user** or an employee supporting that workflow.
