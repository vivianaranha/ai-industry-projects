# Software — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **software operations** by applying **personalized experience and content** to a realistic product issue. The user persona is typically a **user** or an employee supporting that workflow.
