# Software — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **software operations** by applying **email form and intake automation** to a realistic product issue. The user persona is typically a **user** or an employee supporting that workflow.
