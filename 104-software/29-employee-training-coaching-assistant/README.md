# Software — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **software operations** by applying **employee training and coaching assistant** to a realistic product issue. The user persona is typically a **user** or an employee supporting that workflow.
...
- Business outcome specific to Software
...
- Replace CSV sample data with approved Software data sources.
