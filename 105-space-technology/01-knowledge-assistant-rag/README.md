# Space Technology — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **space operations** by applying **knowledge assistant with rag** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
