# Space Technology — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **space operations** by applying **document intelligence and extraction** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
