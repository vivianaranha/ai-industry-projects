# Space Technology — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **space operations** by applying **intelligent classification and triage** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
