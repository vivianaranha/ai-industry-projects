# Space Technology — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **space operations** by applying **ai support copilot** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
