# Space Technology — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **space operations** by applying **kpi insight and root cause analysis** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
