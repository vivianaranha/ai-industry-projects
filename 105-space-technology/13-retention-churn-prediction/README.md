# Space Technology — Retention and Churn Prediction

## Business Problem

This project demonstrates how AI can support **space operations** by applying **retention and churn prediction** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
