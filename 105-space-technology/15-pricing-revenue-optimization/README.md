# Space Technology — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **space operations** by applying **pricing and revenue optimization** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
