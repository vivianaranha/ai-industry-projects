# Space Technology — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **space operations** by applying **lead and opportunity scoring** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
