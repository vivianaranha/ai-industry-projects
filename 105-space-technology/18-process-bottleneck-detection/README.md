# Space Technology — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **space operations** by applying **process bottleneck detection** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
