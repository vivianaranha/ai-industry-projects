# Space Technology — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **space operations** by applying **scenario planning and what-if analysis** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
