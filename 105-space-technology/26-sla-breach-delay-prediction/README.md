# Space Technology — SLA Breach and Delay Prediction

## Business Problem

This project demonstrates how AI can support **space operations** by applying **sla breach and delay prediction** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
