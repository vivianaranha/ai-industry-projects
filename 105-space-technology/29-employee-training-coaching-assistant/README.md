# Space Technology — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **space operations** by applying **employee training and coaching assistant** to a realistic mission event. The user persona is typically a **engineer** or an employee supporting that workflow.
...
- Business outcome specific to Space Technology
...
- Replace CSV sample data with approved Space Technology data sources.
