# Sports — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **sports operations** by applying **document intelligence and extraction** to a realistic event. The user persona is typically a **fan** or an employee supporting that workflow.
