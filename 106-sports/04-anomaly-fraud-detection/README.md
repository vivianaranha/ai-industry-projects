# Sports — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **sports operations** by applying **anomaly and fraud detection** to a realistic event. The user persona is typically a **fan** or an employee supporting that workflow.
