# Sports — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **sports operations** by applying **compliance and policy monitoring** to a realistic event. The user persona is typically a **fan** or an employee supporting that workflow.
