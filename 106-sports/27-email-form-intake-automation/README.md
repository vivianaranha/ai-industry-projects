# Sports — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **sports operations** by applying **email form and intake automation** to a realistic event. The user persona is typically a **fan** or an employee supporting that workflow.
