# Sports — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **sports operations** by applying **employee training and coaching assistant** to a realistic event. The user persona is typically a **fan** or an employee supporting that workflow.
...
- Business outcome specific to Sports
...
- Replace CSV sample data with approved Sports data sources.
