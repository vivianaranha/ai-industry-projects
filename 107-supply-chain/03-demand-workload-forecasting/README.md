# Supply Chain — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **demand and workload forecasting** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
