...
This project demonstrates how AI can support **supply-chain operations** by applying **operational optimization** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
