# Supply Chain — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **ai support copilot** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
