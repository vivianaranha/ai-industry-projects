# Supply Chain — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **predictive maintenance and asset health** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
