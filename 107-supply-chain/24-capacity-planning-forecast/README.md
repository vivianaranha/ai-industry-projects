# Supply Chain — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **capacity planning forecast** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
