# Supply Chain — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **employee training and coaching assistant** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
...
- Business outcome specific to Supply Chain
...
- Replace CSV sample data with approved Supply Chain data sources.
