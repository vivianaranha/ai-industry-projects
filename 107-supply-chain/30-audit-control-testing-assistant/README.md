# Supply Chain — Audit and Control Testing Assistant

## Business Problem

This project demonstrates how AI can support **supply-chain operations** by applying **audit and control testing assistant** to a realistic shipment. The user persona is typically a **planner** or an employee supporting that workflow.
