# Telecommunications — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **network operations** by applying **knowledge assistant with rag** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
