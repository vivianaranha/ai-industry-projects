# Telecommunications — Compliance and Policy Monitoring

## Business Problem

This project demonstrates how AI can support **network operations** by applying **compliance and policy monitoring** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
