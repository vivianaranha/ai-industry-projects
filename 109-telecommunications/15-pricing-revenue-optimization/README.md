# Telecommunications — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **network operations** by applying **pricing and revenue optimization** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
