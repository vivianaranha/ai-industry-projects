# Telecommunications — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **network operations** by applying **process bottleneck detection** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
