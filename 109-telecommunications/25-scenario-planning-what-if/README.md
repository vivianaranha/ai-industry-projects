# Telecommunications — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **network operations** by applying **scenario planning and what-if analysis** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
