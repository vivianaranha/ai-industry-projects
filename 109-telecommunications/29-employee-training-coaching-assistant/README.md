# Telecommunications — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **network operations** by applying **employee training and coaching assistant** to a realistic service event. The user persona is typically a **subscriber** or an employee supporting that workflow.
...
- Business outcome specific to Telecommunications
...
- Replace CSV sample data with approved Telecommunications data sources.
