# Tourism — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **tourism operations** by applying **document intelligence and extraction** to a realistic booking. The user persona is typically a **traveler** or an employee supporting that workflow.
