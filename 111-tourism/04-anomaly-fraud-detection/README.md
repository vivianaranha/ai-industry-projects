# Tourism — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **tourism operations** by applying **anomaly and fraud detection** to a realistic booking. The user persona is typically a **traveler** or an employee supporting that workflow.
