# Tourism — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **tourism operations** by applying **recommendation and next best action** to a realistic booking. The user persona is typically a **traveler** or an employee supporting that workflow.
