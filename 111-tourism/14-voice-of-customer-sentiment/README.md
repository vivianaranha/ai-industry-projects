# Tourism — Voice of Customer and Sentiment Intelligence

## Business Problem

This project demonstrates how AI can support **tourism operations** by applying **voice of customer and sentiment intelligence** to a realistic booking. The user persona is typically a **traveler** or an employee supporting that workflow.
