# Tourism — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **tourism operations** by applying **employee training and coaching assistant** to a realistic booking. The user persona is typically a **traveler** or an employee supporting that workflow.
...
- Business outcome specific to Tourism
...
- Replace CSV sample data with approved Tourism data sources.
