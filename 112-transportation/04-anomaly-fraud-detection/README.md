# Transportation — Anomaly and Fraud Detection

## Business Problem

This project demonstrates how AI can support **transportation operations** by applying **anomaly and fraud detection** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
