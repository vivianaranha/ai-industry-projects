# Travel — Knowledge Assistant with RAG

## Business Problem

This project demonstrates how AI can support **travel operations** by applying **knowledge assistant with rag** to a realistic trip. The user persona is typically a **traveler** or an employee supporting that workflow.
