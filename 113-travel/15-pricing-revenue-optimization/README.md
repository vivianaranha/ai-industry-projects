# Travel — Pricing and Revenue Optimization

## Business Problem

This project demonstrates how AI can support **travel operations** by applying **pricing and revenue optimization** to a realistic trip. The user persona is typically a **traveler** or an employee supporting that workflow.
