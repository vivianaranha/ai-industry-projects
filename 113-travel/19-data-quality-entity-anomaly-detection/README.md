# Travel — Data Quality and Entity Anomaly Detection

## Business Problem

This project demonstrates how AI can support **travel operations** by applying **data quality and entity anomaly detection** to a realistic trip. The user persona is typically a **traveler** or an employee supporting that workflow.
