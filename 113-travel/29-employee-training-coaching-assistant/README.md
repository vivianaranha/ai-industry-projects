# Travel — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **travel operations** by applying **employee training and coaching assistant** to a realistic trip. The user persona is typically a **traveler** or an employee supporting that workflow.
...
- Business outcome specific to Travel
...
- Replace CSV sample data with approved Travel data sources.
