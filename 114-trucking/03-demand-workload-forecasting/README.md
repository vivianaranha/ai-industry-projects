# Trucking — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **fleet operations** by applying **demand and workload forecasting** to a realistic load. The user persona is typically a **dispatcher** or an employee supporting that workflow.
