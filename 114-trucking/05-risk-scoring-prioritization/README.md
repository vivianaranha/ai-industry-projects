# Trucking — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **fleet operations** by applying **risk scoring and prioritization** to a realistic load. The user persona is typically a **dispatcher** or an employee supporting that workflow.
