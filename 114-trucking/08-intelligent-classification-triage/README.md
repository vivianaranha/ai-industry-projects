# Trucking — Intelligent Classification and Triage

## Business Problem

This project demonstrates how AI can support **fleet operations** by applying **intelligent classification and triage** to a realistic load. The user persona is typically a **dispatcher** or an employee supporting that workflow.
