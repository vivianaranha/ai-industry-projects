# Trucking — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **fleet operations** by applying **capacity planning forecast** to a realistic load. The user persona is typically a **dispatcher** or an employee supporting that workflow.
