# Trucking — Email Form and Intake Automation

## Business Problem

This project demonstrates how AI can support **fleet operations** by applying **email form and intake automation** to a realistic load. The user persona is typically a **dispatcher** or an employee supporting that workflow.
