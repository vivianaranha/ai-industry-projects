# Utilities — KPI Insight and Root Cause Analysis

## Business Problem

This project demonstrates how AI can support **utility operations** by applying **kpi insight and root cause analysis** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
