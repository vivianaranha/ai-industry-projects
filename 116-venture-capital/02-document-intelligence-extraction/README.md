# Venture Capital — Document Intelligence and Extraction

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **document intelligence and extraction** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
