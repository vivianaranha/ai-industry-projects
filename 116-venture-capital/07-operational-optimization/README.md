# Venture Capital — Operational Optimization

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **operational optimization** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
