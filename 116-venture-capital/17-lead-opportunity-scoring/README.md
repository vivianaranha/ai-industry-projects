# Venture Capital — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **lead and opportunity scoring** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
