# Venture Capital — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **capacity planning forecast** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
