# Venture Capital — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **scenario planning and what-if analysis** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
