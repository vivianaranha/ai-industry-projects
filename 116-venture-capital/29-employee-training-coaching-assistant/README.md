# Venture Capital — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **investment operations** by applying **employee training and coaching assistant** to a realistic deal record. The user persona is typically a **founder** or an employee supporting that workflow.
...
- Business outcome specific to Venture Capital
...
- Replace CSV sample data with approved Venture Capital data sources.
