# Veterinary Services — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **veterinary services operations** by applying **predictive maintenance and asset health** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
