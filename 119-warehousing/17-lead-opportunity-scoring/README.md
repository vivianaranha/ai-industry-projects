# Warehousing — Lead and Opportunity Scoring

## Business Problem

This project demonstrates how AI can support **warehouse operations** by applying **lead and opportunity scoring** to a realistic fulfillment task. The user persona is typically a **operator** or an employee supporting that workflow.
