# Water & Wastewater — Demand and Workload Forecasting

## Business Problem

This project demonstrates how AI can support **water operations** by applying **demand and workload forecasting** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
