# Water & Wastewater — Risk Scoring and Prioritization

## Business Problem

This project demonstrates how AI can support **water operations** by applying **risk scoring and prioritization** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
