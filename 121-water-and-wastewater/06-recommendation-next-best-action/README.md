# Water & Wastewater — Recommendation and Next Best Action

## Business Problem

This project demonstrates how AI can support **water operations** by applying **recommendation and next best action** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
