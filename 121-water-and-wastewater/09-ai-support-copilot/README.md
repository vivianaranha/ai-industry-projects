# Water & Wastewater — AI Support Copilot

## Business Problem

This project demonstrates how AI can support **water operations** by applying **ai support copilot** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
