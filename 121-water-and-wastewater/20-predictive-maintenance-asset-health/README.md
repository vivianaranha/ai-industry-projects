# Water & Wastewater — Predictive Maintenance and Asset Health

## Business Problem

This project demonstrates how AI can support **water operations** by applying **predictive maintenance and asset health** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
