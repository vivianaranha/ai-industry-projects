# Water & Wastewater — Employee Training and Coaching Assistant

## Business Problem

This project demonstrates how AI can support **water operations** by applying **employee training and coaching assistant** to a realistic service event. The user persona is typically a **customer** or an employee supporting that workflow.
...
- Business outcome specific to Water & Wastewater
...
- Replace CSV sample data with approved Water & Wastewater data sources.
