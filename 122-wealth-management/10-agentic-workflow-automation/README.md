# Wealth Management — Agentic Workflow Automation

## Business Problem

This project demonstrates how AI can support **advisory operations** by applying **agentic workflow automation** to a realistic portfolio event. The user persona is typically a **client** or an employee supporting that workflow.
