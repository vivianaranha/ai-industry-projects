# Wealth Management — Personalized Experience and Content

## Business Problem

This project demonstrates how AI can support **advisory operations** by applying **personalized experience and content** to a realistic portfolio event. The user persona is typically a **client** or an employee supporting that workflow.
