# Wealth Management — Capacity Planning Forecast

## Business Problem

This project demonstrates how AI can support **advisory operations** by applying **capacity planning forecast** to a realistic portfolio event. The user persona is typically a **client** or an employee supporting that workflow.
