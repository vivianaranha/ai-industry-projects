# Wealth Management — Scenario Planning and What-If Analysis

## Business Problem

This project demonstrates how AI can support **advisory operations** by applying **scenario planning and what-if analysis** to a realistic portfolio event. The user persona is typically a **client** or an employee supporting that workflow.
