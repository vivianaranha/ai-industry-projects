# Wholesale & Distribution — Process Bottleneck Detection

## Business Problem

This project demonstrates how AI can support **wholesale & distribution operations** by applying **process bottleneck detection** to a realistic business record. The user persona is typically a **customer** or an employee supporting that workflow.
